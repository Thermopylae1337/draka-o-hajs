...
public class LobbyController : NetworkBehaviour
{
    ...
    public void Add_TeamRpc(ulong id)
    {
        ...
        { 
            ...
            Remaining_Teams.RemoveAt(0);
            Debug.LogWarning(General_Game_Data.Team_List_Serializer(Teams));
    ...
    public void Update_Team_ListRpc(string LoT) 
    {
        ...
        Debug.LogWarning("teamscount " + Teams.Count);
    }
    ...
    public void Load_LicRpc( ) 
    {
        ...
        Debug.LogWarning("pre-scene change " +NetMan.ConnectedClients[0].ClientId + "  " + NetMan.ConnectedClients[1].ClientId);
        if (!IsHost)
        {
        ...
        {
            NetMan.SceneManager.LoadScene("Licytacja", LoadSceneMode.Single);
        }
    }
    ...
    public void Receive_Team_Info_Rpc(ulong recipient_id, string Team_Name) {
        if (NetMan.LocalClientId==recipient_id) {
            ...
            Debug.LogWarning("received team name of" + Team_Name);
        }
    } 
